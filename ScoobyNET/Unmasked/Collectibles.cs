...
namespace ScoobyNET.Unmasked
{
	public class Collectibles
	{
		...
		private static Dictionary<uint, string[]> foodBitMap = new Dictionary<uint, string[]>
		{
			...
			[13] = new string[] { "?", "?", "Broccoli", "Pickle", "Lobster", "Sausage", "Onion", "Carrot" },
			[14] = new string[] { "?", "?", "?", "?", "Broccoli", "Chocolate Bar", "Popcorn", "Shrimp" },
			[15] = new string[] { "?", "?", "?", "?", "Cheese", "Cabbage", "Fish", "Cotton Candy" },
			[16] = new string[] { "?", "?", "?", "?", "?", "?", "Ham", "Marshmallows" },
			[17] = new string[] { "?", "?", "?", "?", "Banana", "Apple", "Pepperoni", "Eggplant" },
